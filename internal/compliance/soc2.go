...
func soc2TypeIIBenchmark() *Benchmark {
	return &Benchmark{
		...
		Controls: []Control{
			...
			{ID: "CC1.1", Title: "COSO Principle 1: The entity demonstrates a commitment to integrity and ethical values", Section: "Control Environment", Severity: cloud.SeverityMedium, Description: "Requires organizational policy review; no cloud API carries it, so this control is reported as not evaluated."},

			// CC2 — Communication and Information
			{ID: "CC2.1", Title: "COSO Principle 13: The entity obtains or generates relevant, quality information", Section: "Communication and Information", Severity: cloud.SeverityLow, Description: "Requires policy and communication review; no cloud API carries it, so this control is reported as not evaluated."},

			// CC3 — Risk Assessment
			{ID: "CC3.1", Title: "COSO Principle 6: The entity specifies objectives with sufficient clarity to identify risks", Section: "Risk Assessment", Severity: cloud.SeverityMedium, Description: "Requires risk assessment process review; no cloud API carries it, so this control is reported as not evaluated."},

			// CC4 — Monitoring Activities
			{ID: "CC4.1", Title: "COSO Principle 16: The entity selects, develops, and performs ongoing evaluations", Section: "Monitoring Activities", Severity: cloud.SeverityMedium, Description: "Requires process-level monitoring review; no cloud API carries it, so this control is reported as not evaluated."},

			// CC5 — Control Activities
			{ID: "CC5.1", Title: "COSO Principle 10: The entity selects and develops control activities", Section: "Control Activities", Severity: cloud.SeverityMedium, Description: "Requires organizational control activity review; no cloud API carries it, so this control is reported as not evaluated."},
			...
			{ID: "CC8.1", Title: "Changes to infrastructure and software are authorized and managed", Section: "Change Management", Severity: cloud.SeverityMedium, Description: "Requires ITSM and change management process review; no cloud API carries it, so this control is reported as not evaluated."},

			// CC9 — Risk Mitigation
			{ID: "CC9.1", Title: "The entity identifies, selects, and develops risk mitigation activities", Section: "Risk Mitigation", Severity: cloud.SeverityMedium, Description: "Requires vendor and contract scope review; no cloud API carries it, so this control is reported as not evaluated."},
