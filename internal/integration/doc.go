...
// directly; package cmd drives runCompliance that way, exercising its flags, its
// exit code and the artifact it writes rather than reading them. The other
// report-reading handlers can be driven the same way and are not yet.
//
